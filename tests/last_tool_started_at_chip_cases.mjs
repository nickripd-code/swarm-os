import {lastToolStartedAtView, LAST_TOOL_START_UNAVAILABLE, recordedToolStartedAtFeed} from "../app/static/state.mjs";

const cases = {};
const visible = {visible: true};

function view(feed, options = visible) {
  return lastToolStartedAtView(feed, options);
}

cases.unavailable = LAST_TOOL_START_UNAVAILABLE;
cases.noMission = view(
  [{event_type: "tool.started", created_at: "2026-09-23T12:35:04Z"}],
  {visible: false},
);
cases.preview = view(
  [{event_type: "tool.started", created_at: "2026-09-23T12:35:04Z"}],
...
cases.empty = view([]);
cases.cursorBefore = view(recordedToolStartedAtFeed([
  {id: 1, event_type: "tool.started", created_at: "2026-09-23T12:35:04Z"},
], -1, true));
cases.feedNotLoaded = view(recordedToolStartedAtFeed([
  {id: 1, event_type: "tool.started", created_at: "2026-09-23T12:35:04Z"},
], 0, false));
cases.nonTool = view([
...
cases.taskOnly = view([
  {event_type: "task.started", created_at: "2026-09-23T12:15:00Z"},
]);
cases.verificationOnly = view([
  {event_type: "verification.started", created_at: "2026-09-23T12:20:00Z"},
]);
cases.completedOnly = view([
  {event_type: "tool.completed", created_at: "2026-09-23T12:25:00Z"},
]);
cases.failedOnly = view([
  {event_type: "tool.failed", created_at: "2026-09-23T12:26:00Z"},
]);
cases.clock = view([
  ...
  {event_type: "tool.started", created_at: "2026-09-23T12:35:04.123456Z", payload: {name: "echo"}},
]);
cases.offset = view([
  {event_type: "tool.started", created_at: "2026-09-23T08:35:04-04:00"},
]);
cases.newestByTime = view([
  {event_type: "tool.started", created_at: "2026-09-23T12:40:00Z"},
  {event_type: "tool.completed", created_at: "2026-09-23T12:55:00Z"},
  {event_type: "tool.started", created_at: "2026-09-23T12:10:00Z"},
  {event_type: "tool.started", created_at: "2026-09-23T12:50:09Z"},
]);
cases.kinds = view([
...
cases.taskDoesNotOverride = view([
  {event_type: "tool.started", created_at: "2026-09-23T12:35:04Z"},
...
cases.replayPrefix = view(recordedToolStartedAtFeed([
  ...
  {id: 3, event_type: "tool.started", created_at: "2026-09-23T12:36:00Z"},
], 1, true));
cases.replayAtLater = view(recordedToolStartedAtFeed([
  {id: 1, event_type: "mission.started", created_at: "2026-09-23T12:00:00Z"},
  {id: 2, event_type: "tool.started", created_at: "2026-09-23T12:35:04Z"},
  {id: 3, event_type: "tool.started", created_at: "2026-09-23T12:36:00Z"},
], 2, true));
cases.replayBeforeTool = view(recordedToolStartedAtFeed([
  {id: 1, event_type: "mission.started", created_at: "2026-09-23T12:00:00Z"},
  {id: 2, event_type: "tool.started", created_at: "2026-09-23T12:35:04Z"},
], 0, true));
cases.missingTime = view([{event_type: "tool.started"}]);
cases.blankTime = view([{event_type: "tool.started", created_at: ""}]);
cases.whitespace = view([{event_type: "tool.started", created_at: " 2026-09-23T12:35:04Z"}]);
cases.numericZero = view([{event_type: "tool.started", created_at: 0}]);
cases.numericNow = view([{event_type: "tool.started", created_at: 1758630904000}]);
cases.stringZero = view([{event_type: "tool.started", created_at: "0"}]);
cases.epoch = view([{event_type: "tool.started", created_at: "1970-01-01T00:00:00Z"}]);
cases.epochFraction = view([{event_type: "tool.started", created_at: "1970-01-01T00:00:00.000000Z"}]);
cases.naive = view([{event_type: "tool.started", created_at: "2026-09-23T12:35:04"}]);
cases.garbage = view([{event_type: "tool.started", created_at: "just now"}]);
cases.impossibleDay = view([{event_type: "tool.started", created_at: "2026-02-31T12:35:04Z"}]);
cases.newestInvalid = view([
  {event_type: "tool.started", created_at: "2026-09-23T12:00:00Z"},
  {event_type: "tool.started", created_at: ""},
]);
cases.nonObject = view(["tool.started"]);
cases.otherToolStates = view([
  {event_type: "tool.completed", created_at: "2026-09-23T12:30:00Z"},
  {event_type: "tool.failed", created_at: "2026-09-23T12:31:00Z"},
]);
...
cases.spendIgnored = view([
  {event_type: "tool.started", created_at: "2026-09-23T12:35:04Z", payload: {token_spent: 9, input_tokens: 100}},
]);
cases.explicitEmptyFeed = recordedToolStartedAtFeed([], -1, true);
cases.notArrayLog = recordedToolStartedAtFeed({length: 0}, 0, true);

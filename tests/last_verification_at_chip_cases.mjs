import {lastVerificationAtView, LAST_VERIFY_AT_NONE, LAST_VERIFY_AT_UNAVAILABLE, recordedVerificationAtFeed} from "../app/static/state.mjs";

const cases = {};
const visible = {visible: true};

function view(feed, options = visible) {
  return lastVerificationAtView(feed, options);
}

cases.unavailable = LAST_VERIFY_AT_UNAVAILABLE;
cases.none = LAST_VERIFY_AT_NONE;
...
cases.empty = view([]);
cases.cursorBefore = view(recordedVerificationAtFeed([
  {id: 1, event_type: "verification.started", created_at: "2026-09-23T12:35:04Z"},
], -1, true));
cases.feedNotLoaded = view(recordedVerificationAtFeed([
...
cases.kinds = view([
  {event_type: "verification.started", created_at: "2026-09-23T01:02:03Z"},
]);
cases.evidenceDoesNotOverride = view([
  {event_type: "verification.passed", created_at: "2026-09-23T12:35:04Z"},
  {event_type: "verification.evidence.failed", created_at: "2026-09-23T13:00:00Z"},
]);
cases.replayPrefix = view(recordedVerificationAtFeed([
  {id: 1, event_type: "mission.started", created_at: "2026-09-23T12:00:00Z"},
  {id: 2, event_type: "verification.started", created_at: "2026-09-23T12:35:04Z"},
  {id: 3, event_type: "verification.passed", created_at: "2026-09-23T12:36:00Z"},
], 1, true));
cases.replayAtLater = view(recordedVerificationAtFeed([
  {id: 1, event_type: "mission.started", created_at: "2026-09-23T12:00:00Z"},
  {id: 2, event_type: "verification.started", created_at: "2026-09-23T12:35:04Z"},
  {id: 3, event_type: "verification.passed", created_at: "2026-09-23T12:36:00Z"},
], 2, true));
cases.missingTime = view([{event_type: "verification.started"}]);
...
cases.numericZero = view([{event_type: "verification.started", created_at: 0}]);
cases.numericNow = view([{event_type: "verification.failed", created_at: 1758630904000}]);
cases.stringZero = view([{event_type: "verification.started", created_at: "0"}]);

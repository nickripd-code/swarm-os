import {lastToolOkAtView, LAST_TOOL_OK_AT_NONE, LAST_TOOL_OK_AT_UNAVAILABLE, recordedToolOkAtFeed} from "../app/static/state.mjs";

const cases = {};
const visible = {visible: true};

function view(feed, options = visible) {
  return lastToolOkAtView(feed, options);
}

cases.unavailable = LAST_TOOL_OK_AT_UNAVAILABLE;
cases.none = LAST_TOOL_OK_AT_NONE;
...
cases.empty = view([]);
cases.cursorBefore = view(recordedToolOkAtFeed([
  {id: 1, event_type: "tool.completed", created_at: "2026-09-23T12:35:04Z"},
], -1, true));
cases.feedNotLoaded = view(recordedToolOkAtFeed([
  {id: 1, event_type: "tool.completed", created_at: "2026-09-23T12:35:04Z"},
], 0, false));
cases.nonOk = view([
  ...
  {event_type: "tool.failed", created_at: "2026-09-23T12:37:00Z"},
...
cases.offset = view([
  {event_type: "tool.completed", created_at: "2026-09-23T08:35:04-04:00"},
]);
cases.newestByTime = view([
  ...
  {event_type: "tool.failed", created_at: "2026-09-23T12:59:00Z"},
  {event_type: "tool.completed", created_at: "2026-09-23T12:50:09Z"},
]);
cases.kinds = view([
  {event_type: "tool.completed", created_at: "2026-09-23T01:02:03Z"},
]);
cases.replayBeforeOk = view(recordedToolOkAtFeed([
  ...
  {id: 3, event_type: "tool.completed", created_at: "2026-09-23T12:35:04Z"},
  {id: 4, event_type: "tool.failed", created_at: "2026-09-23T12:35:30Z"},
  {id: 5, event_type: "tool.completed", created_at: "2026-09-23T12:36:00Z"},
], 1, true));
cases.replayPrefix = view(recordedToolOkAtFeed([
  {id: 1, event_type: "mission.started", created_at: "2026-09-23T12:00:00Z"},
  {id: 2, event_type: "tool.started", created_at: "2026-09-23T12:34:00Z"},
  {id: 3, event_type: "tool.completed", created_at: "2026-09-23T12:35:04Z"},
  {id: 4, event_type: "tool.failed", created_at: "2026-09-23T12:35:30Z"},
...
cases.replayAtLater = view(recordedToolOkAtFeed([
  {id: 1, event_type: "mission.started", created_at: "2026-09-23T12:00:00Z"},
  {id: 2, event_type: "tool.started", created_at: "2026-09-23T12:34:00Z"},
  {id: 3, event_type: "tool.completed", created_at: "2026-09-23T12:35:04Z"},
  {id: 4, event_type: "tool.failed", created_at: "2026-09-23T12:35:30Z"},
...
cases.missingTime = view([{event_type: "tool.completed"}]);
cases.blankTime = view([{event_type: "tool.completed", created_at: ""}]);
cases.whitespace = view([{event_type: "tool.completed", created_at: " 2026-09-23T12:35:04Z"}]);
cases.numericZero = view([{event_type: "tool.completed", created_at: 0}]);
cases.numericNow = view([{event_type: "tool.completed", created_at: 1758630904000}]);
cases.stringZero = view([{event_type: "tool.completed", created_at: "0"}]);
...
cases.newestInvalid = view([
  {event_type: "tool.completed", created_at: "2026-09-23T12:00:00Z"},
...
cases.laterNonOk = view([
  ...
  {event_type: "tool.failed", created_at: "2026-09-23T12:41:00Z"},
]);

import {lastTaskStoppedAtView, LAST_TASK_STOP_UNAVAILABLE, recordedTaskStoppedAtFeed} from "../app/static/state.mjs";

const cases = {};
const visible = {visible: true};

function view(feed, options = visible) {
  return lastTaskStoppedAtView(feed, options);
}

cases.unavailable = LAST_TASK_STOP_UNAVAILABLE;
...
cases.empty = view([]);
cases.cursorBefore = view(recordedTaskStoppedAtFeed([
  {id: 1, event_type: "task.stopped", created_at: "2026-09-23T12:35:04Z"},
], -1, true));
cases.feedNotLoaded = view(recordedTaskStoppedAtFeed([
  {id: 1, event_type: "task.stopped", created_at: "2026-09-23T12:35:04Z"},
], 0, false));
cases.nonTask = view([
...
cases.clock = view([
  ...
  {event_type: "task.stopped", created_at: "2026-09-23T12:35:04.123456Z", payload: {status: "running"}},
]);
cases.offset = view([
  {event_type: "task.stopped", created_at: "2026-09-23T08:35:04-04:00"},
]);
cases.newestByTime = view([
  {event_type: "task.stopped", created_at: "2026-09-23T12:40:00Z"},
  {event_type: "llm.started", created_at: "2026-09-23T12:55:00Z"},
  {event_type: "task.stopped", created_at: "2026-09-23T12:10:00Z"},
  {event_type: "task.stopped", created_at: "2026-09-23T12:50:09Z"},
]);
cases.kinds = view([
  {event_type: "task.stopped", created_at: "2026-09-23T01:02:03Z"},
]);
...
cases.replayPrefix = view(recordedTaskStoppedAtFeed([
  {id: 1, event_type: "mission.started", created_at: "2026-09-23T12:00:00Z"},
  {id: 2, event_type: "task.stopped", created_at: "2026-09-23T12:35:04Z"},
  {id: 3, event_type: "task.stopped", created_at: "2026-09-23T12:36:00Z"},
], 1, true));
cases.replayAtLater = view(recordedTaskStoppedAtFeed([
  {id: 1, event_type: "mission.started", created_at: "2026-09-23T12:00:00Z"},
  {id: 2, event_type: "task.stopped", created_at: "2026-09-23T12:35:04Z"},
  {id: 3, event_type: "task.stopped", created_at: "2026-09-23T12:36:00Z"},
], 2, true));
cases.replayBeforeTask = view(recordedTaskStoppedAtFeed([
  {id: 1, event_type: "mission.started", created_at: "2026-09-23T12:00:00Z"},
  {id: 2, event_type: "task.stopped", created_at: "2026-09-23T12:35:04Z"},
], 0, true));
cases.missingTime = view([{event_type: "task.stopped"}]);
cases.blankTime = view([{event_type: "task.stopped", created_at: ""}]);
cases.whitespace = view([{event_type: "task.stopped", created_at: " 2026-09-23T12:35:04Z"}]);
cases.numericZero = view([{event_type: "task.stopped", created_at: 0}]);
cases.numericNow = view([{event_type: "task.stopped", created_at: 1758630904000}]);
cases.stringZero = view([{event_type: "task.stopped", created_at: "0"}]);
cases.epoch = view([{event_type: "task.stopped", created_at: "1970-01-01T00:00:00Z"}]);
cases.epochFraction = view([{event_type: "task.stopped", created_at: "1970-01-01T00:00:00.000000Z"}]);
cases.naive = view([{event_type: "task.stopped", created_at: "2026-09-23T12:35:04"}]);
cases.garbage = view([{event_type: "task.stopped", created_at: "just now"}]);
cases.impossibleDay = view([{event_type: "task.stopped", created_at: "2026-02-31T12:35:04Z"}]);
cases.newestInvalid = view([
  {event_type: "task.stopped", created_at: "2026-09-23T12:00:00Z"},
  {event_type: "task.stopped", created_at: ""},
]);
cases.nonObject = view(["task.stopped"]);
...
cases.missionStopIgnored = view([
  {event_type: "mission.stopped", created_at: "2026-09-23T12:35:04Z"},
]);
cases.taskStartedIgnored = view([
...
cases.missionStopDoesNotOverride = view([
  {event_type: "task.stopped", created_at: "2026-09-23T12:35:04Z"},
  {event_type: "mission.stopped", created_at: "2026-09-23T13:00:00Z"},
]);
cases.spendIgnored = view([
  {event_type: "task.stopped", created_at: "2026-09-23T12:35:04Z", payload: {token_spent: 9, input_tokens: 100}},
]);
cases.explicitEmptyFeed = recordedTaskStoppedAtFeed([], -1, true);
cases.notArrayLog = recordedTaskStoppedAtFeed({length: 0}, 0, true);

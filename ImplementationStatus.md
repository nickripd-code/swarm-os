...
**Recommended next backend slice:** OrganizationDesigner remains reserved. External evidence runners (tests/endpoints/files) or ModelRouter historical success / cost-aware ranking. Isolated live wallet behind this seam is later — do not enable spending. Still fail closed. Still no game-world UI rewrite.

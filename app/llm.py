...
from .credentials import (
    get_api_key, get_anthropic_api_key, get_gemini_api_key, get_mistral_api_key,
    get_openrouter_api_key, get_xai_api_key,
)
...
def build_model_provider(primary: ModelProvider | None = None,
    ...
    """Cloud OpenAI + optional OpenRouter/xAI/Anthropic/Mistral/Gemini, locals last.
    ...
    clouds = [item for item in (primary, secondary, xai, anthropic, mistral, gemini) if provider_configured(item)]
...
def build_router(model_provider: ModelProvider | None = None,
    ...
    provider = model_provider or build_model_provider(
        xai=xai, anthropic=anthropic, mistral=mistral, gemini=gemini, local=local,

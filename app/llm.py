...
from .credentials import (
    get_api_key, get_anthropic_api_key, get_cohere_api_key, get_gemini_api_key,
    get_mistral_api_key, get_openrouter_api_key, get_xai_api_key,
)
...
def build_model_provider(primary: ModelProvider | None = None,
    ...
    """Cloud OpenAI + optional OpenRouter/xAI/Anthropic/Mistral/Gemini/Cohere, locals last.
    ...
    clouds = [item for item in (primary, secondary, xai, anthropic, mistral, gemini, cohere) if provider_configured(item)]
